...
export const reviews: Review[] = [
  {
    ...
    rating: 5,
    comment: 'Absolutely the best restaurant in Dhaka! The Kacchi Biryani was heavenly — rich, aromatic, and perfectly cooked. The ambiance is top-notch and service is impeccable. I bring every guest here.',
    date: '2026-03-20',
  ...
  },
  {
    ...
    name: 'Sultana Razia',
    rating: 5,
    comment: 'Rizqara never disappoints! We celebrated our anniversary here and the staff went above and beyond. The BBQ Platter was phenomenal. This place is truly world-class for Dhaka.',
    date: '2026-03-15',
    location: 'Dhaka, Bangladesh',
  },
  {
